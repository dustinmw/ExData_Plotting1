...
plot(dataload$DateTime, dataload$GlobalActivePower, xlab = '', ylab = 'Global Active Power (kilowatt)', type = 'l')
plot(dataload$DateTime, dataload$Voltage, xlab = 'datetime', ylab = 'Voltage', type = 'l')
plot(dataload$DateTime, dataload$SubMetering1, xlab = '', ylab = 'Energy sub metering', type = 'l')
plot(dataload$DateTime, dataload$GlobalReactivePower, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l')
